...
import { ColisionAnimation } from './collsionAnimation.js';
    ...
    checkCollision(){
        this.game.enemies.forEach(enemy => {
            if(enemy.x < this.x + this.width &&
                ...
                this.game.collisions.push(new ColisionAnimation(this.game, enemy.x + enemy.width * 0.5, enemy.y + enemy.heigth * 0.5));
